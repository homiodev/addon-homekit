...
public class HomekitAccessoryFactory {
    ...
    private static class HomekitSlat extends AbstractHomekitAccessory<CurrentSlatStateCharacteristic> implements SlatAccessory {
        ...
        private final SlatTypeCharacteristic slatTypeCharacteristic;
        ...
        public HomekitSlat(@NotNull HomekitEndpointContext ctx) {
            ...
            slatTypeCharacteristic = new SlatTypeCharacteristic(() -> completedFuture(ctx.endpoint().getSlatType()));
            addCharacteristicToService(slatTypeCharacteristic);
        }
        ...
        public CompletableFuture<SlatTypeEnum> getSlatType() {
            return slatTypeCharacteristic.getEnumValue();
        }
    }
    ...
    private static class HomekitHeaterCooler extends AbstractStatusActiveHomekitAccessory implements HeaterCoolerAccessory {
        ...
        private final CurrentTemperatureCharacteristic currentTemperatureCharacteristic;
        private final CurrentHeaterCoolerStateCharacteristic currentHeaterCoolerStateCharacteristic;
        private final TargetHeaterCoolerStateCharacteristic targetHeaterCoolerStateCharacteristic;
        ...
        public HomekitHeaterCooler(@NotNull HomekitEndpointContext ctx) {
            ...
            currentTemperatureCharacteristic = getCharacteristic(CurrentTemperatureCharacteristic.class);
            currentHeaterCoolerStateCharacteristic = getCharacteristic(CurrentHeaterCoolerStateCharacteristic.class);
            targetHeaterCoolerStateCharacteristic = getCharacteristic(TargetHeaterCoolerStateCharacteristic.class);
        ...
        public CurrentHeaterCoolerStateEnum[] getCurrentHeaterCoolerStateValidValues() {
            ...
            return currentHeaterCoolerStateCharacteristic.getValidValues();
        }
        ...
        public TargetHeaterCoolerStateEnum[] getTargetHeaterCoolerStateValidValues() {
            ...
            return targetHeaterCoolerStateCharacteristic.getValidValues();
        }

        @Override
        public CompletableFuture<Double> getCurrentTemperature() {
            return currentTemperatureCharacteristic.getValue();
        }

        @Override
        public CompletableFuture<CurrentHeaterCoolerStateEnum> getCurrentHeaterCoolerState() {
            return currentHeaterCoolerStateCharacteristic.getEnumValue();
        }

        @Override
        public CompletableFuture<TargetHeaterCoolerStateEnum> getTargetHeaterCoolerState() {
            return targetHeaterCoolerStateCharacteristic.getEnumValue();
        }
        ...
        public CompletableFuture<Void> setTargetHeaterCoolerState(TargetHeaterCoolerStateEnum state) {
            ...
            targetHeaterCoolerStateCharacteristic.setValue(state);
            return completedFuture(null);
        }
        ...
        public void subscribeCurrentHeaterCoolerState(HomekitCharacteristicChangeCallback callback) {
            ...
            currentHeaterCoolerStateCharacteristic.subscribe(callback);
        }
        ...
        public void unsubscribeCurrentHeaterCoolerState() {
            ...
            currentHeaterCoolerStateCharacteristic.unsubscribe();
        }
        ...
        public void subscribeTargetHeaterCoolerState(HomekitCharacteristicChangeCallback callback) {
            ...
            targetHeaterCoolerStateCharacteristic.subscribe(callback);
        }
        ...
        public void unsubscribeTargetHeaterCoolerState() {
            ...
            targetHeaterCoolerStateCharacteristic.unsubscribe();
        }
        ...
        public void subscribeCurrentTemperature(HomekitCharacteristicChangeCallback callback) {
            ...
            currentTemperatureCharacteristic.subscribe(callback);
        }
        ...
        public void unsubscribeCurrentTemperature() {
            ...
            currentTemperatureCharacteristic.unsubscribe();
        }
    }
    ...
    private static class HomekitLock extends AbstractHomekitAccessory<LockCurrentStateCharacteristic> implements LockMechanismAccessory {
        private final LockTargetStateCharacteristic lockTargetStateCharacteristic;
        ...
        public HomekitLock(@NotNull HomekitEndpointContext ctx) {
            ...
            lockTargetStateCharacteristic = getCharacteristic(LockTargetStateCharacteristic.class);
        }
        ...
        public CompletableFuture<LockTargetStateEnum> getLockTargetState() {
            return lockTargetStateCharacteristic.getEnumValue();
        }
        ...
        public CompletableFuture<Void> setLockTargetState(LockTargetStateEnum state) {
            ...
            lockTargetStateCharacteristic.setValue(state);
            return completedFuture(null);
        }
        ...
        public void subscribeLockTargetState(HomekitCharacteristicChangeCallback callback) {
            ...
            lockTargetStateCharacteristic.subscribe(callback);
        }
        ...
        public void unsubscribeLockTargetState() {
            ...
            lockTargetStateCharacteristic.unsubscribe();
        }
    }
    ...
    private static class HomekitSmartSpeaker extends AbstractHomekitAccessory<CurrentMediaStateCharacteristic> implements SmartSpeakerAccessory {
        private final TargetMediaStateCharacteristic targetMediaStateCharacteristic;
        ...
        public HomekitSmartSpeaker(@NotNull HomekitEndpointContext ctx) {
            ...
            targetMediaStateCharacteristic = getCharacteristic(TargetMediaStateCharacteristic.class);
        }
        ...
        public CompletableFuture<TargetMediaStateEnum> getTargetMediaState() {
            return targetMediaStateCharacteristic.getEnumValue();
        }
        ...
        public CompletableFuture<Void> setTargetMediaState(final TargetMediaStateEnum targetState) {
            ...
            targetMediaStateCharacteristic.setValue(targetState);
            return completedFuture(null);
        }
        ...
        public void subscribeTargetMediaState(final HomekitCharacteristicChangeCallback callback) {
            ...
            targetMediaStateCharacteristic.subscribe(callback);
        }
        ...
        public void unsubscribeTargetMediaState() {
            ...
            targetMediaStateCharacteristic.unsubscribe();
        }
    }
